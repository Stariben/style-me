    ...
    <section className="bg-background px-5 pt-10 pb-12 overflow-hidden">
      <div className="max-w-lg mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-[2.8rem] font-black leading-[1.12] tracking-tight text-foreground mb-4"
        >
        ...
        <motion.button
          ...
          className="inline-flex items-center gap-2 bg-foreground text-background font-semibold text-lg px-9 py-5 rounded-full hover:opacity-85 active:scale-95 transition-all shadow-xl shadow-foreground/15"
        >
